...
import { getLegalList } from '@/content/legal';
      ...
      <body className="flex min-h-screen flex-col bg-background text-foreground">
        ...
        <footer className="border-t-2 border-border">
          <div className="mx-auto max-w-6xl space-y-2 px-4 py-4">
            <p className="text-xs text-muted">Legally binding in Kazakh and Russian; English is a translation.</p>
            <LegalLinks lang="en" docs={getLegalList('en').map(({ slug, title }) => ({ slug, title }))} />
          </div>
        </footer>
        <ConsentMount />
      </body>
